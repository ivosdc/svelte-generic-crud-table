let myData = [
    ...
    {name: 'Your Name', job: 'no', private: '<img .../> tag', html: '<img src="https://sapper.svelte.dev/sapper-logo-horizontal.svg" width="78px"/>'},
    {name: 'Jim', job: 'code', private: 'sthg@here.where', html: '<a href="https://ivolution.one">some html</a>'},
    {name: 'John', job: 'tester', private: 'books', html: '<a href="https://ivolution.one">html</a>'},
    {name: 'Alice', job: 'code', private: 'OSS', html: '<a href="https://ivolution.one">html</a>'},
    {name: 'Nicole', job: 'design', private: 'painting', html: '<a href="https://ivolution.one">html</a>'},
    {name: 'myRealName', job: 'hmm', private: 'personal info', html: '<a href="https://ivolution.one">html</a>'},
    {name: 'Your Name', job: 'no', private: '122/456789', html: '<a href="https://ivolution.one">html</a>'},
    {name: 'Jim', job: 'code', private: 'sthg@here.where', html: '<a href="https://ivolution.one">html</a>'},
    {name: 'John', job: 'tester', private: 'books', html: '<a href="https://ivolution.one">html</a>'},
    {name: 'Alice', job: 'code', private: 'OSS', html: '<a href="https://ivolution.one">html</a>'},
    {name: 'Nicole', job: 'design', private: 'painting', html: '<a href="https://ivolution.one">html</a>'},
    {name: 'myRealName', job: 'hmm', private: 'personal info', html: '<a href="https://ivolution.one">html</a>'},
    ...
    {name: 'Alice', job: 'code', private: 'OSS', html: '<a href="https://ivolution.one">html</a>'},
    {name: 'Nicole', job: 'design', private: 'painting', html: '<a href="https://ivolution.one">html</a>'},
    {name: 'Denis', job: 'coder', private: 'sports', html: '<a href="https://ivolution.one">html</a>'},
    {name: 'Marc', job: 'trainer', private: 'rc models', html: '<a href="https://ivolution.one">html</a>'},
    {name: 'Timme', job: 'diverse', private: 'timme', html: '<a href="https://ivolution.one">html</a>'},
    {name: 'Chuck', job: 'hero', private: 'Norris', html: '<a href="https://ivolution.one">html</a>'}
];
