...
/* src/SvelteGenericCrudTable.svelte generated by Svelte v3.31.2 */
...
function create_if_block_1(ctx) {
	...
	return {
		c() {
			...
			set_style(div1, "border-left", "0.1em solid #efefef");
